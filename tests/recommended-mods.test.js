...
function testStaticServerBoundary() {
  ...
  assert.match(staticServer.resolvePublicFile('/docs/THIRD_PARTY_NOTICES.md'), /docs[\\/]THIRD_PARTY_NOTICES\.md$/)
  assert.match(staticServer.resolvePublicFile('/docs/TODO.md'), /docs[\\/]TODO\.md$/)
  assert.equal(staticServer.resolvePublicFile('/docs/unknown.md'), null)
